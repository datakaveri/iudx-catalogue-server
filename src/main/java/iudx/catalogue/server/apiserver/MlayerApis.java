...
public class MlayerApis {
  ...
  public void getMlayerInstanceHandler(RoutingContext routingContext) {
    ...
    //-> New changes
//  public void getMlayerInstanceHandler(RoutingContext routingContext) {
//      LOGGER.debug("Info: getMlayerInstanceHandler started");
//
//      JsonObject requestParams = parseRequestParamsInstance(routingContext);
//
//      HttpServerResponse response = routingContext.response();
//      response.putHeader(HEADER_CONTENT_TYPE, MIME_APPLICATION_JSON);
//
//      handleMlayerServiceInstance(requestParams, response);
//  }
//    private JsonObject parseRequestParamsInstance(RoutingContext routingContext) {
...
//
//        if (id != null) {
//            requestParams.put(INSTANCE_ID, id);
//            return requestParams.put(LIMIT, limitInt).put(OFFSET, offsetInt);
//        }
//
...
//    }
//    private void handleMlayerServiceInstance(JsonObject requestParams, HttpServerResponse response) {
//        LOGGER.debug("Info: handleMlayerService() started");
