...
public class Constants {
  ...
  public static final String GET_MLAYER_BOOL_GEOQUERY =
      "{\"bool\": {\"should\": [{ \"match\": { \"type.keyword\": \"iudx:Resource\" } },{ \"match\""
              + ": \"type.keyword\": \"iudx:ResourceGroup\" } }],\"must\": [{\"match\": "
              + "{\"instance.keyword\": \"$2\"}},{\"match\": {\"id.keyword\": \"$3\"}}]}}";
