...
public class Constants {
  ...
  public static final String DISTANCE_IN_METERS = "m";
  ...
  public static final String GEO_JSON_LOCATION = "geoJsonLocation";
  public static final String GEO_KEY = "location.geometry";
