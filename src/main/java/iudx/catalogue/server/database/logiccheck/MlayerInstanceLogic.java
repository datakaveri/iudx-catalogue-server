...
public class MlayerInstanceLogic {
    private static final Logger LOGGER = LogManager.getLogger(MlayerInstanceLogic.class);
    ...
    public MlayerInstanceLogic(ElasticClient client, String mlayerInstanceIndex) {
        this.client = client;
    ...
    public void createMlayerInstance(JsonObject instanceDoc, Handler<AsyncResult<JsonObject>> handler) {

        LOGGER.error("Checking endpoints at in createMlayerinstance 105");
    ...
    public void updateMlayerInstance(JsonObject request, Handler<AsyncResult<JsonObject>> handler) {
        LOGGER.error("Checking endpoints at in deleteMlayer 169");
