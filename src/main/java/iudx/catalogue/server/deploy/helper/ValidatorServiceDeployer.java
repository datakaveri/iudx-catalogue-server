...
/**
 * The Catalogue Server Validator Service Deployer.
 * <h1>Catalogue Server Validator Service Deployer</h1>
 * <p>
 * The Validator Service Deployer deploys the Validator Service Verticle.
 * </p>
 * 
...
public class ValidatorServiceDeployer {

  private static final Logger logger = LoggerFactory.getLogger(ValidatorServiceDeployer.class);
  private static Vertx vertx;
  private static ClusterManager mgr;
  private static VertxOptions options;

  /**
   * The main method implements the deploy helper script for deploying the Validator Service
