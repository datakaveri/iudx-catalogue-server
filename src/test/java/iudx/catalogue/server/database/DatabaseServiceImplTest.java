...
public class DatabaseServiceImplTest {
    ...
    @Mock
    AsyncResult<Boolean> asyncResultBoolean;
    @Mock
    Throwable throwable;
    ...
    public void testGetRatings(VertxTestContext vertxTestContext) {
        ...
        }).when(DatabaseServiceImpl.client).ratingAggregationAsync(any(),any(), any());
        databaseService.getRatings(json,handler->{
            if(handler.succeeded()){
                verify(DatabaseServiceImpl.client,times(1)).ratingAggregationAsync(any(),any(),any());
                vertxTestContext.completeNow();
            }
            else {
                vertxTestContext.completeNow();
    ...
    public void testDeleteRating3(VertxTestContext vertxTestContext) {
        ...
        }).when(DatabaseServiceImpl.client).docPutAsync(any(),any(),any(),any());
