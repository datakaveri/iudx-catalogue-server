      ...
      steps{
        node('built-in') {
          script{
            ...
            sh 'HTTP_PROXY=\'127.0.0.1:8090\' newman run /var/lib/jenkins/iudx/cat/Newman/iudx-catalogue-server-v4.5.0.postman_collection.json -e /home/ubuntu/configs/4.5.0/cat-postman-env.json -n 2 --delay-request 1000 --insecure -r htmlextra --reporter-htmlextra-export /var/lib/jenkins/iudx/cat/Newman/report/report.html --reporter-htmlextra-skipSensitiveData'
            runZapAttack()
          }
        }
      }
